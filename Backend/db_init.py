...
def create_procedures():
    ...
    cursor = mysql.connection.cursor()
    procedures_file_paths = ["./sql_queries/procedures/institution_procedures.sql", "./sql_queries/procedures/department_procedures.sql", "./sql_queries/procedures/person_procedures.sql",
                             "./sql_queries/procedures/project_procedures.sql",  "./sql_queries/procedures/belongsto_crud.sql", 
                              "./sql_queries/procedures/project_tag_procedures.sql",  "./sql_queries/procedures/tag_procedures.sql",
...
def insert_initial_data():
    ...
    json_data = get_json_data("./data/post_cleaning_usm_data.json")
    ...
    try:
        ...
        for dept_key, dept_data in departments.items():
            ...
            for person_name, person_data in people.items():
                ...
                if (len(person_data.get("person_phone")) > 15):
                    print(person_name)
